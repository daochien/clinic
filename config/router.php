...
//                ]
        ...
        'inquiry' => [
            ...
            'groups' => [
                'view' => [
                    'name' => 'View list',
                    'routes' => ['inquiry.list','api.inquiry.list', 'inquiry.show', 'api.inquiry.attachment.download', 'api.inquiry.search', 'inquiry.index']
                ],
                'create' => [
                    'name' => 'Create',
...
//                ]
        ...
        'page' => [
            ...
            'groups' => [
                ...
                'update' => [
                    'name' => 'Update',
                    'routes' => ['page.show', 'page.update', 'page.rating']
                ],
                'delete' => [
                    'name' => 'Delete',
                    'routes' => ['page.destroy']
