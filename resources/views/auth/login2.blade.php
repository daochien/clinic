        ...
        <div class="main-content-container container-fluid px-4 my-auto h-100">
            <div class="row no-gutters h-100">
                <div class="col-lg-6 col-md-6 mx-auto my-auto no-gutters">
                    <div class="mt-5 mb-5">
                        <h1 class="text-center">{{ __('auth.login._page_title') }} {{ Auth::user()->name?? "" }}</h1>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-8 mx-auto my-auto">
                                    <h3 class="auth-form__title text-center mb-4">{{ __('auth.login.form._subtitle') }}</h3>
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control  @error('email') is-invalid @enderror" name="email"
                                                   ...
                                                   aria-describedby="emailHelp" placeholder="{{ __('auth.login.form._mail_address_pl') }}">
                                            @error('email')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" class="form-control  @error('password') is-invalid @enderror"
                                                   ...
                                                   placeholder="{{ __('auth.login.form._password_pl') }}">
                                        </div>
                                        <button type="submit" class="col-12 btn btn-primary mt-3">
                                            {{ __('auth.login.others._btn_login') }}
                                        </button>
