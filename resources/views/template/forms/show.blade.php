                    ...
                    <h5 class="card-title">
                        ...
                        <div class="btn-toolbar float-md-right" role="toolbar">
                            <div class="btn-group" role="group">
                                <a href="{{ route('template::template.index') }}" class="btn btn-primary float-md-right btn-sm">
                                    <i class="fa fa-arrow-left"></i>
                                </a>
                                <a href="{{ route('template::template.submissions.index', $form) }}" class="btn btn-primary float-md-right btn-sm">
                                    <i class="fa fa-th-list"></i> Submissions
                                </a>
                                <a href="{{ route('template::template.edit', $form) }}" class="btn btn-primary float-md-right btn-sm">
                                    <i class="fa fa-edit"></i> Edit
                                </a>
                                <a href="{{ route('template::template.create') }}" class="btn btn-primary float-md-right btn-sm">
