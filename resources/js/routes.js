export default [
...

    {
        path: '/admin/group',
        component: {template: '<router-view/>'},
        name: 'group', meta: {breadcrumb: `スタッフ管理`},
        children: [
            ...
            { path: '/admin/group/users', component: require('./components/admin/group/Members.vue').default, name:'users_group', meta: {breadcrumb: `クリニック一覧`} },
        ]
    },
