export default [
    ...
    { path: '/admin/template', component: require('./components/admin/template/Index.vue').default },
    { path: '/admin/template/create', component: require('./components/admin/template/Create.vue').default },
