...
class RenderFormController extends Controller
{
    ...
    public function render($identifier)
    {
        ...
        return view('template.render.index', compact('form', 'pageTitle'));
    }
    ...
    public function submit(Request $request, $identifier)
    {
        ...
        try {
            ...
            return redirect()
                    ->route('template.form.feedback', $identifier)
    ...
    public function feedback($identifier)
    {
        ...
        return view('template.render.feedback', compact('form', 'pageTitle'));
    }
}
