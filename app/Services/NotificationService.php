...
class NotificationService
{
    ...
    {
        $notificationUsers = NotificationUser::with(['userStatus', 'notification'])->orderBy('notifications.created_at', 'desc');
        ...
        return $notificationUsers->select('notifications.*')->paginate(20);
    }
}
